...
باقی‌مانده‌ی ریز: بازطراحی بازبینی محتوا (#۱۲)، پیش‌نمایش نهایی گزارش (#۶)، آوردن انواع پیش‌فرض
داخل مدیریت انواع (#۱۰)، نمای هفته/لیست تقویم، اتصال کارت مالی داشبورد به finance.
