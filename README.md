...
> **برای توسعه:** [`CLAUDE.md`](./CLAUDE.md) (نقشه + قوانین + تله‌ها، خودکار لود می‌شود)،
> `<app>/CLAUDE.md` (جزئیات هر اپ)، [`docs/RECIPES.md`](./docs/RECIPES.md) (دستورالعمل افزودن)،
> [`docs/CONVENTIONS.md`](./docs/CONVENTIONS.md) (قراردادها و Definition of Done).
