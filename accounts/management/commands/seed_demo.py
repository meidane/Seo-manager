...
رویشان حساس است: عضویتِ پروژه، تسکِ دلیگیت‌شده، دیدِ زیرمجموعه، own_tasks_only)،
...
# نقشِ سفارشیِ «سرپرستِ تیم» — عمداً manage_projects/manage_colleagues ندارد، تا
# سناریوی «سرپرستِ محدود به پروژه‌ی خودش + زیرمجموعه‌هایش» (نه دسترسیِ سازمانی) هم
# قابل‌تست باشد؛ نقشِ built-in «سرپرست» خودش manage_projects دارد (نامحدود در همه‌جا).
TEAMLEAD_ROLE = {
